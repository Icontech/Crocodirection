...
package com.dsandberg.crocodirection.graphics;
...
import com.dsandberg.crocodirection.models.Group;
import com.dsandberg.crocodirection.models.Material;
...
public class Model3D extends ARObject implements Serializable{
	...
	public Model3D(Model model) {
		super("model", "crocomark", 80.0, new double[]{0,0});
		this.model = model;
		model.finalize();
